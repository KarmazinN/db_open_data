...
### Життєвий цикл даних
- Створення даних.
Першим етапом життєвого циклу даних є створення / збір даних. Ці дані можуть мати різні форми, наприклад PDF, зображення, документ Word, дані бази даних SQL. Дані зазвичай створюються організацією одним із 3 способів: збір даних[1](#11), введення даних: ручне введення нових даних працівниками організації, захоплення даних: збір даних, що генеруються пристроями, що використовуються в різних процесах в організації
